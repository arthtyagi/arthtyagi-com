...
const CustomLink = (
  props: { href: string; children: React.ReactNode } | any
) => {
  const { href } = props;
  if (href.startsWith("/")) {
    return (
  ...
  return (
    <a
      className="link-underline link-underline-black text-orange-500"
      target="_blank"
...
export function Mdx({ code }: MdxProps) {
  ...
  return (
    <article className="prose prose-quoteless prose-neutral text-2xl text-zinc-700 tracking-tight">
