    ...
    <div className="font-triumph gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
      ...
      <div className="flex flex-col items-stretch w-[46%] ml-5 max-md:w-full max-md:ml-0">
        <Image
          ...
          width={512}
          src={"/hero.png"}
          className="aspect-[0.96] hover:filter hover:grayscale duration-1000 object-contain object-center w-full border overflow-hidden
         my-auto border-solid border-black max-md:max-w-full max-md:mt-10"
          alt="Image"
        />
      </div>
